 ...
 */
$(function () {
    map_info = {'size':[1100,590],'map_url':'xxxx','rate':[1.18,1.235],'op':[2.4,2.4],'current_position':[200,200]};
    ...
    p = '<img id="path" src="/images/po.gif">';
    path_div = '<div id="path_div"></div>div>';
    xy = '<img id="path" src="/images/path.gif">';
    $('#image').cropper({
        // aspectRatio: 16 / 9,
        guides: false,
        // autoCrop: false,
    ...
    function init_p(e) {
        ...
        lp = parseFloat(map_info.current_position[0]) * map_info.rate[0] * (parseFloat(dp[0].style.width) / parseFloat(1298)) +
                        parseFloat(map_info.op[0] * map_info.rate[0]) - 16;
        dp[1].style.left = lp;
        tp = parseFloat(map_info.current_position[1]) * map_info.rate[1] * (parseFloat(dp[0].style.height) / parseFloat(729)) +
                        parseFloat(map_info.op[1] * map_info.rate[1]) - 16;
        dp[1].style.top = tp;
